...
- Scope: a character portrait home screen (display only; no zoom), one 5x5 tactical room, four movement cards, two enemy types, preview and replay. Returning home preserves the current room in memory; a finished room starts fresh.
